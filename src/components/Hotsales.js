  ...
  return (
    <div>
      ...
      <div className="w-60 m-auto bg-[var(--primary-color)] rounded-br-3xl rounded-tl-3xl ">
        <h3 className="text-3xl text-center self-center uppercase font-bold text-[var(--second-color)] overflow-hidden py-3 mt-10 mb-5">
          Hot Sales
        </h3>
      </div>
      <div className="flex flex-row flex-wrap justify-center gap-4">
        {productsData.hotsales.map((product, index) => (
          <div key={index} className="">
            <div
              className="container-item w-60 p-2 border border-gray-300 rounded-3xl relative cursor-pointer"
